<template>
  ...
  <div>
      ...
      <transition name=".el-fade-in-linear">
        <el-form v-if="isshow" label-position="left" :model="dmsRegistrationParam" ref="dmsRegistrationParam" label-width="80px" :inline="true" class="demo-form-inline" style="padding:0 0 0 100px;border-style: solid;border-width: 0px 0px 1px 0px;border-color:#C0C0C0;" :rules="rules">
          ...
          <el-form-item style="width:300px" label="支付方式" prop="settlementCatId" >
            <el-select style="width:150px" v-model="dmsRegistrationParam.settlementCatId" placeholder="请选择支付方式" @change="WXpay">
              <el-option
          ...
          <el-form-item style="width:300px" label="付款码"  v-show="WXPayState"><!--:disabled="isAble"-->
            <el-input placeholder="付款码" style="width:180px;color:black" ref="editTask"  v-model="dmsRegistrationParam.barCode"  @keyup.enter.native="searchEnterFun" :disabled="isAble"></el-input>
          </el-form-item>
          ...
          <el-form-item style="width:300px" :inline="true" label="总金额" prop="summery">
            <el-input v-model="dmsRegistrationParam.summery" placeholder="总金额" ></el-input>
          </el-form-item>

          <el-form-item style="width:300px" :inline="true" label="可用金额" prop="blance">
            <el-input v-model="dmsRegistrationParam.blance" placeholder="可用金额" ></el-input>
          </el-form-item>

          <el-form-item style="width:300px" :inline="true" label="冻结金额" prop="frozen">
            <el-input v-model="dmsRegistrationParam.frozen" placeholder="冻结金额" ></el-input>
          </el-form-item>

          <el-form-item style="width:300px" :inline="true" label="充值金额" prop="topUp">
            <el-input v-model="dmsRegistrationParam.topUp" placeholder="充值金额" ></el-input>
          </el-form-item>
          ...
          <el-form-item style="align-content: center">
            <el-button style="align-content: center" type="primary" @click="createRegistration('dmsRegistrationParam')">挂号&打印发票</el-button>
          </el-form-item>

          <el-form-item style="align-content: center">
            <el-button style="align-content: center" type="primary" @click="recharge()">充值</el-button>
          </el-form-item>

          <el-form-item style="align-content: center">
            <el-button style="align-content: center" type="primary" @click="rollback()">退费</el-button>
          </el-form-item>
    ...
    <div v-show="dialogFormVisible&&!refundVisible" style="text-align:center">
      ...
      <el-select style="width:150px" v-model="settlementCatId" placeholder="请选择支付方式" @change="WXpay1">
        <el-option
          v-for="item in paytype"
          :key="item.value"
          :label="item.label"
      ...
      <!--开药付款的地方-->
      <!--:disabled="isAble"-->   <!--v-show="WXPayState1"--> <!-- v-model="dmsRegistrationParam.barCode"-->  <!--@keyup.enter.native="searchEnterFun" :disabled="isAble"-->
      <el-input placeholder="付款码" style="width:180px;color:black" ref="editTask" v-show="WXPayState1" @keyup.enter.native="searchEnterFun" :disabled="isAble" v-model="xbarCode"></el-input>
