  ...
  <el-container>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button type="primary" @click="updateInform(scope.row)">修改</el-button>
            <el-button type="primary" @click="deleteFamiliarInform(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </el-aside>
    ...
    <transition name="el-zoom-in-left">
      <el-main width="50%" v-show="isclose" style="border-style: dotted;border-width: 0px 0px 0px 1px;border-color:#C0C0C0;margin-top:-12px">
        <el-tabs>
          <el-tab-pane label="知情告知模板" name="first">
            <el-table highlight-current-row @row-dblclick="addModel" stripe :data="informList" height="230">
    ...
    <el-dialog :visible.sync="itemvisible" title="增加知情告知" width="600px">
      <el-form :model="addInformParam">  <!--:rules="rules"-->
        <el-form-item label="知情告知名字" > <!--prop="name"-->
          <el-input placeholder="模板名字" v-model="addInformParam.name" style="width:400px"></el-input>
        </el-form-item>
        <el-form-item label="知情告知内容">  <!--prop="content"-->
          <el-input placeholder="模板内容" maxlength="500" type="textarea" :autosize="{ minRows: 2, maxRows: 3}" v-model="addInformParam.content" style="width:400px"></el-input>
        </el-form-item>
        <el-button type="primary" @click="insertFamiliarInform">增加</el-button>
      </el-form>
    </el-dialog>

    <!--修改弹出层-->
    <el-dialog :visible.sync="itemvisible1" title="增加知情告知" width="600px">
      <el-form :model="addInformParam" :rules="rules">
        <el-form-item label="知情告知名字" prop="name">
        ...
        <el-button type="primary" @click="updateFamiliarInform">修改</el-button>
      </el-form>
    </el-dialog>
  ...
  export default {
    ...
    data(){
      return{
        /*rules: {
          name: [
            { required: true, message: '请输入知情告知名字', trigger: 'blur' },
            { min: 1, max: 30, message: '长度在 1 到 30 个字符', trigger: 'blur' }
          ],
          content: [
            { required: true, message: '请输入知情告知内容', trigger: 'blur' },
