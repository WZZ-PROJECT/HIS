        ...
        <el-main>
          ...
          <el-form inline label-width="100px">
            ...
            <el-form-item label="付数">
              <el-input-number controls-position="right" style="width:100px" :min="1" :max="100"
                               v-model="oneprescription.pairNum" placeholder="付数"></el-input-number>
            </el-form-item>
          </el-form>
          ...
          <el-table height="500px" :data="oneprescription.druglist" cell-style="text-align:center"
            ...
            <el-table-column label="频次" width="130px">
              <template slot-scope="scope">
                <el-select v-model="scope.row.frequency" placeholder="" style="width:120px">
                  <el-option v-for="item in [{key:1,label:'一天一次'},{key:2,label:'一天三次'}]"
                             :key="item.key"
            ...
            <el-table-column label="用量" width="100px">
              <template slot-scope="scope">
                <el-input-number controls-position="right" style="width: 100px" v-model="scope.row.usageNum" :min="1" :max="100"></el-input-number>
              </template>
            </el-table-column>
            <el-table-column label="单位" width="130px">
              <template slot-scope="scope">
                <el-select v-model="scope.row.usageNumUnit" placeholder="" style="width:120px">
                  <el-option v-for="item in [{key:1,label:'片'},{key:2,label:'支'},{key:3,label:'瓶'},{key:4,label:'克'}]"
  ...
  export default {
    ...
    methods: {
      ...
      createpre() {
        ...
        if (this.oneprescription.medicalAdvice === undefined || this.oneprescription.medicalAdvice === "" || this.oneprescription.medicalAdvice === null) {
          this.$notify({
            title: "信息不完整",
            message: "请输入嘱托！",
            type: "warning",
        ...
        if (this.oneprescription.therapy === undefined || this.oneprescription.therapy === "" || this.oneprescription.therapy === null) {
          this.$notify({
            title: "信息不完整",
            message: "请输入治法！",
            type: "warning",
        ...
        if (this.oneprescription.pairNum === undefined || this.oneprescription.pairNum === "" || this.oneprescription.pairNum === null) {
          this.$notify({
            title: "信息不完整",
            message: "请输入付数！",
            type: "warning",
        ...
        this.oneprescription.druglist.forEach(item=>{
          ...
          if (data===0 && (item.medicalAdvice === undefined || item.medicalAdvice === "" || item.medicalAdvice === null)) {
            this.$notify({
              title: "信息不完整",
              message: "请输入医嘱！",
              type: "warning",
          ...
          if (data===0 && (item.footnote === undefined || item.footnote === "" || item.footnote === null)) {
            this.$notify({
              title: "信息不完整",
              message: "请输入脚注！",
              type: "warning",
          ...
          if (data===0 && (item.frequency === undefined || item.frequency === "" || item.frequency === null)) {
            this.$notify({
              title: "信息不完整",
              message: "请输入频次！",
              type: "warning",
          ...
          if (data===0 && (item.usageNum === undefined || item.usageNum === "" || item.usageNum === null)) {
            this.$notify({
              title: "信息不完整",
              message: "请输入用量！",
              type: "warning",
          ...
          if (data===0 && (item.usageNumUnit === undefined || item.usageNumUnit === "" || item.usageNumUnit === null)) {
            this.$notify({
              title: "信息不完整",
              message: "请输入单位！",
              type: "warning",
     ...
     /* getDrugPrescription() {
      ...
      print(e) {
        const subOutputRankPrint = document.getElementById('Cprescription1')
