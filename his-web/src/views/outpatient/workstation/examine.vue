    ...
    <el-aside :width="mainwidth" style="background:white;padding:0 10px 0 0">
      ...
      <el-table
        ...
        <el-table-column
          ...
          show-overflow-tooltip>
          <template slot-scope="scope">
            <el-button type="text" v-if="scope.row.status===-1" @click="demand(scope.row)">检验要求</el-button>
    ...
    <el-dialog title="填写检验要求" :visible.sync="demandVisible">
      <div style="height:260px">
        <el-form inline label-width="100px" :model="check" ref="check" :rules="rules">
          ...
          <el-form-item label="检验部位" prop="checkParts">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      print(e) {
        const subOutputRankPrint = document.getElementById('examine1')
