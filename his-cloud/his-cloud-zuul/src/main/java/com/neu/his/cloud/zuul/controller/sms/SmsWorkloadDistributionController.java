...
public class SmsWorkloadDistributionController {
    ...
    public CommonResult<CommonPage<SmsWorkloadResult>>  queryDeptPersonalWorkloadList(@RequestParam("deptId") Long deptId,
        ...
        return apiPcSmsWorkloadDistributionService.queryDeptPersonalWorkloadList(deptId,startDatetime,endDatetime,pageSize,pageNum);
    }
    private CommonResult<CommonPage<SmsWorkloadResult>>  queryDeptPersonalWorkloadListFallbackInfo(Long deptId,String startDatetime,String endDatetime,Integer pageSize,Integer pageNum){
        return CommonResult.success(null,"请检查您的网络") ;
    }
