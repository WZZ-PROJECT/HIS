...
public class DmsDiseCatalogDistributionController {
    ...
    public CommonResult<CommonPage<DmsDiseCatalogResult>> listAll(@RequestBody DmsDiseCatalogParam dmsDiseCatalogParam){
        return apiPcDmsDiseCatalogDistributionService.listAll(dmsDiseCatalogParam);
    }
    private CommonResult<CommonPage<DmsDiseCatalogResult>> listAllFallbackInfo(DmsDiseCatalogParam dmsDiseCatalogParam){
        return CommonResult.success(null,"请检查您的网络") ;
    }
