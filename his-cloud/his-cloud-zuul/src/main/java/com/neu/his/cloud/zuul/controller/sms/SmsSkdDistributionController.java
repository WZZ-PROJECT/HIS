...
public class SmsSkdDistributionController {
    ...
    @HystrixCommand(fallbackMethod = "listSkdFallbackInfo",commandProperties = {
    ...
    public  CommonResult<CommonPage<SmsSkdResult>> listSkd(@RequestBody SmsSkdParam queryParam){
        ...
        return apiPcSmsSkdDistributionService.listSkd(queryParam);
    }
    private  CommonResult<CommonPage<SmsSkdResult>> listSkdFallbackInfo(SmsSkdParam queryParam){
        return CommonResult.success(null,"请检查您的网络") ;
    }
