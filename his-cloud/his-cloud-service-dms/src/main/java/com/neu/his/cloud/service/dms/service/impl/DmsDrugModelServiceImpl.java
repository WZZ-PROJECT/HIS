...
import com.neu.his.cloud.service.dms.mapper.DmsDrugModelMapper;
import com.neu.his.cloud.service.dms.mapper.DmsHerbalModelItemMapper;
import com.neu.his.cloud.service.dms.mapper.DmsMedicineModelItemMapper;
...
public class DmsDrugModelServiceImpl implements DmsDrugModelService {
    ...
    public List<DmsDrugModelResult> selectModel(Integer isAdmin, DmsDrugModelParam queryParam, Integer pageSize, Integer pageNum) {
        ...
        if(isAdmin == 0){  //非管理员   前台 查询个人、科室、全院
            ...
            if(!StringUtils.isEmpty(queryParam.getScope())){
                criteria.andScopeEqualTo(queryParam.getScope()); //必须mvc保证不为空
            }
            if(!StringUtils.isEmpty(queryParam.getOwnId())){
