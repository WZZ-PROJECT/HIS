...
public class DmsMedicinePrescriptionRecordController {
    ...
    @Autowired
    private DmsRegistrationService service;
    /**
     * 描述:开立处方（发送）
     * <p>author: ma
     */
...
//        ArrayList<BigDecimal> account = new ArrayList();
//        account.add(dmsMedicinePrescriptionRecordParam.getAmount());
//        CommonResult commonResult = service.amountSufficient(dmsMedicinePrescriptionRecordParam.getRegistrationId(), account);
