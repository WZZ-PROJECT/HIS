...
public class DmsDiseCatalogController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<DmsDiseCatalogResult>> listAll(@RequestBody DmsDiseCatalogParam dmsDiseCatalogParam){

        Page page = PageHelper.startPage(dmsDiseCatalogParam.getPageNum(), dmsDiseCatalogParam.getPageSize());
        List<DmsDiseCatalogResult> list = dmsDiseCatalogService.select(dmsDiseCatalogParam,dmsDiseCatalogParam.getPageSize(),dmsDiseCatalogParam.getPageNum());
